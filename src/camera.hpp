...
public:
    ...
    void ProcessMouseMovement(float xoffset, float yoffset, GLboolean constrainPitch = true) {
        float zoomFactor = Zoom / 45.f;
        xoffset *= MouseSensitivity * zoomFactor;
        yoffset *= MouseSensitivity * zoomFactor;
    ...
    void RaiseMovementSpeed() {
        MovementSpeed = DefaultSpeed * 3.0f;
    }

    void LowerMovementSpeed() {
