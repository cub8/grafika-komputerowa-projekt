...
public:
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // === POPRAWNA KOLEJNOŚĆ IMGUI FRAME ===
        Gui::beginFrame();              // <-- ZACZNIJ NOWĄ KLATKĘ IMGUI
        Gui::render(this);              // <-- RYSUJ GUI
        Gui::endFrame();                // <-- ZAKOŃCZ IMGUI KLATKĘ (Render + ImGui_ImplOpenGL3_RenderDrawData)

        // === RESZTA RENDEROWANIA SCENY ===
