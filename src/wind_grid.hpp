...
private:
    ...
    void initUkrainianVectors() {
        std::vector<WindVector> vectors = {
            ...
            WindVector(glm::vec2(1.0f, -0.1f), glm::vec2(20.50f, 8.11f), 60.0f),
            WindVector(glm::vec2(1.0f,  0.7f), glm::vec2(24.33f, 9.04f), 25.0f),
        };
    ...
    void initRussianVectors() {
        std::vector<WindVector> vectors = {
            ...
            WindVector(glm::vec2(-0.1f, -1.0f), glm::vec2(30.05f,   0.79f), 80.0f),
    ...
    void initCaspianVectors() {
        std::vector<WindVector> vectors = {
            ...
            WindVector(glm::vec2(1.0f, 0.8f), glm::vec2(28.44f, 11.15f), 25.0f),
        };
    ...
    void initTurkishVectors() {
        std::vector<WindVector> vectors = {
            WindVector(glm::vec2( 0.7f, 1.0f), glm::vec2(21.62f, 11.10f), 20.0f),
            WindVector(glm::vec2(-0.7f, 1.0f), glm::vec2(17.43f, 12.02f), 20.0f),
        };
